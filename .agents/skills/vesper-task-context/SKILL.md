---
name: vesper-task-context
description: Prepare a compact Vesper brief for a fresh agent, resumed session, or bounded handoff. Use when context must cross an agent or session boundary; ordinary progress summaries do not need this workflow.
---

# Prepare Vesper task context
