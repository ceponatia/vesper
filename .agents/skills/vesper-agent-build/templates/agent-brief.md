...
- Read first: the root `AGENTS.md` and `docs/README.md`, then issue #<N>
...
- Do NOT add a test because code exists. Read `.agents/skills/vesper-testing/SKILL.md`:
...
- Do NOT write status, progress, slice numbers, or "remaining work" into
  ...
  (`.agents/skills/vesper-docs/SKILL.md`). Work state lives on the issue.
