...
| [text-models/](text-models/README.md)             | Text-model behavior package: sampling vocabulary, host dialects, composer/registry, execution hints and quirks, plus narrator-model reference |
