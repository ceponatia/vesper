...
| neck, shoulders, chest   | neck (length, throat_prominence); shoulders (width, slope); chest (size — the **chest build**, `flat … barrel` — and hair, both only on a body without the breasts region)                                                                                        |
