...
| `STATE_MODEL` | `google/gemini-2.5-flash` | Post-turn agents, forge agents (default for all `generateChecked` calls) |
| `TOOL_MODEL` | `google/gemini-2.5-flash` | Scene composer |
