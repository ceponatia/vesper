...
- A1 — graduated 2026-07-24 → [../command-integrity.plan.md](../finished/command-integrity.plan.md)
- A2 — graduated 2026-07-24 → [../command-integrity.plan.md](../finished/command-integrity.plan.md)
- A3 [solo-retake.plan.md](solo-retake.plan.md)
- A4 — graduated 2026-07-24 → [../command-integrity.plan.md](../finished/command-integrity.plan.md)
...
- C14 — graduated 2026-07-24 → [../sim-read-seam-guards.plan.md](../finished/sim-read-seam-guards.plan.md)
- C15 — graduated 2026-07-23 → [../drain-hardening.diagnostics.md](../finished/drain-hardening.diagnostics.md)
- C16 — graduated 2026-07-24 → [../sim-read-seam-guards.plan.md](../finished/sim-read-seam-guards.plan.md) (folded into the C14 plan per owner ruling; stub removed)

**Graduated:** A1+A2+A4 promoted 2026-07-24 as the one command-integrity plan
[../command-integrity.plan.md](../finished/command-integrity.plan.md) (serialize, survive,
atomize; discussion-complete at parking, all three stubs removed).
A5+A6+A7+C15 promoted 2026-07-23
as [../drain-hardening.plan.md](../finished/drain-hardening.plan.md) (owner lifted the
...
C14+C16 promoted 2026-07-24 as [../sim-read-seam-guards.plan.md](../finished/sim-read-seam-guards.plan.md)
...
- D17 — graduated + shipped 2026-07-28 → [../sim-chat-capabilities.plan.md](../finished/sim-chat-capabilities.plan.md)
- D18 [sim-stop-cancellation.plan.md](sim-stop-cancellation.plan.md)
- D19 [sim-branch-ux.plan.md](sim-branch-ux.plan.md)
- E20 — graduated 2026-07-27 → [../successor-world-lifecycle.plan.md](../finished/successor-world-lifecycle.plan.md)
- F21 [sim-typed-stream.plan.md](sim-typed-stream.plan.md)
- F22 — graduated + shipped 2026-07-28 → [../sim-world-surface-ux.plan.md](../finished/sim-world-surface-ux.plan.md)
...
- security-authz — graduated 2026-07-25 (same day as parking) →
  [../security-authz.plan.md](../finished/security-authz.plan.md) (S1–S7 from the
