...
The provider defaults `width`/`height` to 1080×1080. `packages/image-core/src/models/quality-presets.ts` sends the same portrait bucket the reviewed set uses
