...
The chat returns to normal legacy authority and the live mirror mapping is removed. The service deletes a mirror world it created, but **does not delete the comparison rows or rulings** you already gathered — they stay attached to the conversation.
