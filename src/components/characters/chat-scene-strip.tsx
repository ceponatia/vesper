...
import { charactersApi, type ImageRecord } from "@/lib/client/api";
...
export function SceneStrip({ characterId, name, hasChat }: { characterId: string; name: string; hasChat: boolean }) {
