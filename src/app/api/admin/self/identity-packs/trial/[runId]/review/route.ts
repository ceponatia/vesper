 ...
 * the pair's derived mapping before storing. The response is a bare receipt —
 * echoing the mapping back would hand the reviewer the one bit this surface
 * exists to withhold. A duplicate grade is a loud `grade_conflict`, and an
