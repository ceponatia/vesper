 ...
 * here is data and vocabulary: no geometry (that is `src/lib/images/identity-pack-crop.ts`),
 * no thresholds (`src/lib/images/identity-pack-policy.ts`), no persistence
 ...
 * `src/server/images/identity-pack-detector.ts`. The detector's OUTPUT shape
 ...
 * (`selectIdentityFaceCandidate` in `src/lib/images/identity-pack-quality.ts`),
 ...
 * in `src/lib/images/identity-pack-policy.ts`, never in a route or a column.
 */
