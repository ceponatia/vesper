 ...
 * and carries per-attribute rules. Human is the only one shipped; humanoid
 * variants (elf, orc, …) are pure data additions, and novel body plans are a
 * later phase. The structural `id` is separate from the free-text
