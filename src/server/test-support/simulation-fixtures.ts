import type { CommandPrincipal } from "@/contracts/simulation/envelopes";
 ...
 */
export function legacyEngineTestPlayerPrincipal(controlledActorIds: string[]): CommandPrincipal {
  return {
    kind: "player",
