...
7. "outfit": what the character is WEARING, only when this exchange CHANGED it. Two ways to say it — pick whichever fits, or {} when nothing changed (the common case). Never record the player's clothing here.
...
Example — the character changes for dinner during the exchange (whole-outfit swap):
...
Example — the character takes a single piece off mid-scene (garment-level delta, not a whole swap):
{"episodeSummary":"The apartment was warm, so Mara shrugged out of her cardigan and draped it over the chair, still mid-story.","facts":[],"memoryQueries":[],"attributeChanges":[],"openLoops":[],"scene":{},"outfit":{"removed":["her cardigan"]},"driveUpdates":[]}
