...
{"sceneSummary":"Gruff Thorne greets the player warmly, then goes quiet; Brian starts asking around.","storySoFar":"Thorne keeps acting out of character; the player is quietly digging into why.","characterNotes":["Thorne is hiding something."],"directives":["Let suspicion build."],"memoryQueries":["Captain Thorne"],"exposure":{"appearance":"ambient","scent":"none","touch":"none"},"atmosphere":"ominous","threadSignals":{"touch":[],"develop":[{"id":"th_thorne","entry":"Warm-then-withdrawn greeting; Brian begins asking around.","entryKind":"statement"}],"propose":[],"resolve":[]},"imageMoment":{"worthIt":false,"description":""}}
