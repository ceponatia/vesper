...
ALTER TABLE "sim_item_holdings" ADD CONSTRAINT "sim_item_holdings_container_fk" FOREIGN KEY ("branch_id","holding_container_id") REFERENCES "public"."sim_holding_containers"("branch_id","holding_container_id") ON DELETE no action ON UPDATE no action DEFERRABLE INITIALLY DEFERRED;--> statement-breakpoint
