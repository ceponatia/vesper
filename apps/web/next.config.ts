...
const nextConfig: NextConfig = {
  ...
  transpilePackages: ["@vesper/contracts", "@vesper/image-core", "@vesper/image-models", "@vesper/image-replicate", "@vesper/image-sd", "@vesper/simulation-core", "@vesper/text-models"],
