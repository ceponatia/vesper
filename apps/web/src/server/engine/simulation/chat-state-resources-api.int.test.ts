...
import { PATCH as inspectorPatch } from "@/app/api/admin/chat-inspector/[chatId]/participants/[characterId]/state/route";
...
describe.runIf(ready)("focused chat-state resources", () => {
  ...
  it("ordinary owner PATCH rejects inspector fields while admin inspector state accepts them", async () => {
