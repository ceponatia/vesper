...
export function CharacterAuthorRecoveryNotice({ recovery, disabled, onRestore, onDiscard }: {
  ...
  return <section role="status" className="mb-4 rounded-card border border-ink-600 bg-ink-850 p-4">
    <p className="text-sm font-medium">Recovered edits need review</p>
    <p className="mt-1 text-sm text-paper-400">The saved character changed since this browser draft began. Your edits are retained; review them before saving.</p>
