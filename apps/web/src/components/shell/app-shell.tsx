 ...
 * <PageContainer>; the conversation screen uses the full viewport.
 *
 ...
 * immersive conversation screen (its fixed footer would collide with the composer); the
...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  // fixed tab bar): the full-screen conversation page — but not the /chat hub,
  // which is a normal list page.
...
/** Standard reading-width wrapper for everything except the conversation screen. */
