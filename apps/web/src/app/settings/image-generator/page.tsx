...
/**
 * The admin-only Image Generator. The `/api/admin/self/image-generator` family
 * is role-gated server-side and 404s for everyone else; the client gate is only
 * so a non-admin gets an explanation rather than a page of failed requests.
 *
