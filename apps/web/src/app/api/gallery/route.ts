 ...
 * (docs/images/pipelines/scene-images.md §The Gallery hub): `?tab=scenes`
 * (default — character-chat scenes, joined to their character),
 * `?tab=portraits` (character portrait variants), `?tab=entity`
