 ...
 * owner's personas new chats start as (the middle rung of `resolveChatPersona`'s
 * ladder). Always scoped to the signed-in user; there is no `:id` form (you can only
 * read or edit yourself).
 *
