 ...
 * contract it reports through
 * (docs/developer-notes/monorepo-image-core.spec.foundation.md). This file stays
 * because it is a genuine application-facing API; it is a re-export barrel and
