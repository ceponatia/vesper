 ...
 * this shape. This file stays because it is a genuine application-facing API that
 * several hundred modules already import; it is a re-export barrel and holds no
