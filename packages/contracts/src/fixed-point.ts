 ...
 * package cannot import the application, and putting it in the simulation
 * package would make chat depend on the successor by package name — the thing
 * the ruling above forbids. The lowest workspace both can reach owns it. The
 * application still spells it `@/lib/fixed-point`, a re-export barrel over this
 * file.
 *
