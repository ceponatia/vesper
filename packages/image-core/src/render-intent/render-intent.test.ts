...
import { imageLabControlRoles } from "../lab/image-lab";
import { imageControlReferenceRoles, isImageControlReferenceRole } from "../capabilities/image-model-capabilities";
import { imageModelSchema, type ImageModel } from "../models/image-models";
import { emptyImageReferencePolicy, type ImageReferencePolicy } from "../models/image-model-profiles";
import {
